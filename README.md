...
- Boosting
    > 랜덤 포레스트와 비슷하나 나무 생성 시 더 높은 무작위성과 단순함을 가짐. 다음 단계의 weak classifier가 이전 단계의 weak classifier의 영향을 받음. 즉, 이전의 classifier의 양상을 보고 보다 잘 맞출 수 있는 방향으로 다음 단계를 진행하고 각 classifier의 weight를 업데이트.
- 활용된 R packages
    > ggplot2, gbm, rf
## 후기
